...
def render(savepath, filename, idx ,orientation, scene_blend = 'base_scene.blend'):
    ...
    light_data = bpy.data.lamps.new(name="Shadow_Light", type='SPOT')
...
if __name__=='__main__':
    ...
    # root = '/data3/rishubh/blender/smart4_vae_label_original_fixed_combined'
    # render_path = '../rendered_cars_smart4_vae_label_original_fixed_combined/'
    os.makedirs(args.render_path,exist_ok=True)
    dataset=iou_dataset(root)
    # start_idx = 1618
    ...
    # for idx in range(start_idx, end_idx):
        ...
        #for i, orientation in enumerate(np.arange(0, 180, 30)):
            #box_idx=2
            ...
            render(render_path, filename, box_idx, orientation)
            print("saved")
