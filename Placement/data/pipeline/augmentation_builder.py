...
from networks.utils.registry import AUGMENTATION_DICT
from data.kitti.kittidata import kitti_obj
...
class Compose(object):
    ...
    def __call__(self, left_image:np.ndarray,
                       ...
                       labels:Union[None, List[kitti_obj]]=None,
                       image_gt:Union[None, np.ndarray]=None,
                       lidar:Union[None, np.ndarray]=None)->List[Union[None, np.ndarray, List[kitti_obj]]]:
        """
